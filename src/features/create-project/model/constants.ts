...
export const TASK_IMPORTANCE_DESCRIPTIONS: Record<string, string> = {
  ...
  'Добавить README с запуском проекта': 'Новые участники смогут подключиться без долгих объяснений.',
  ...
  'Описать первый пользовательский сценарий': 'Это помогает не потерять пользу AI-инструмента за техникой.',
  'Сделать базовый интерфейс запроса': 'Пользователь сможет попробовать основное действие продукта.',
  'Подготовить manifest': 'Расширение получит техническую основу для запуска в браузере.',
  'Сделать popup-интерфейс': 'Команда быстро увидит, как пользователь будет взаимодействовать с продуктом.',
