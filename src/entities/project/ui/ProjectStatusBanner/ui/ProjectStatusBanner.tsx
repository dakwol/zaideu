...
export const ProjectStatusBanner = ({ status, className, onAction }: ProjectStatusBannerProps) => {
  ...
  const bannerConfig = {
    slow: {
      ...
      message:
        'This is normal. Teams often lose momentum mid-project. Take a small step to get back on track.',
      bgClass: 'bg-warning/5 border-warning/20',
      iconClass: 'text-warning',
      actions: [{ label: 'Take a small task', action: 'take_task', icon: ListTodo }],
    },
    stalled: {
      icon: Pause,
  ...
  return (
    <div className={classNames('rounded-lg border p-4', config.bgClass, className)}>
