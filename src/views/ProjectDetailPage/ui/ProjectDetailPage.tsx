...
function ProjectDetailPage({ params }: ProjectPageProps) {
        ...
        <div className={styles.workingGrid}>
          ...
          <aside className={styles.rightColumn}>
            <article className={styles.aboutCard}>
              <h2>О проекте</h2>
              <p>
                Здесь видно, куда движется проект, кто уже делает вклад и какой
                маленький следующий шаг можно взять без долгого онбординга.
              </p>
            </article>
